    ...
    <div>
      ...
      <section id='home' className='br-hero margin-b-50'>
          ...
          <div className='hero-content'>
            <div className='hero-item static'>
              <div className='br-hero-detail'>
                <h1 className='br-hero-title title-right-overflow'>
                  <span>
                    <span className='name'>&nbsp; Info•Chatbot</span>
                  </span>
                </h1>
        ...
        <div
          ...
          data-scroll='about'
          onClick={() => handleScrollNext('about')}
        >
